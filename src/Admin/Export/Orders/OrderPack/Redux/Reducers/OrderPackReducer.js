...
const orderPackReducer = createSlice({
  name: "orderPack",
  initialState: {
    dataSource: [],
    totalPages: "",
  ...
  reducers: {
    ...
    getOrderPacks: (state, action) => {},
    handleDel: () => {},
    getAll: () => {},
  },
});

export const orderPackActions = { ...orderPackReducer.actions };
export default orderPackReducer.reducer;
