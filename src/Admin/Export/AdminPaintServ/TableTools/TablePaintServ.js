...
import { paintServActions } from "../Redux/Reducers/PaintServReducer";
import dayjs from "dayjs";

const TablePaintServ = (props) => {
  useEffect(() => {
    props.getPaintServs();
  }, []);
      ...
      <Modal
       ...
       q
        footer={[
          ...
          <Button
            key="submit"
            form="paintServForm" // ID of the form
            htmlType="submit"
            type="primary"
          >
            Submit
