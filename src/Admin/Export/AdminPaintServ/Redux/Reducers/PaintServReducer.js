...
const paintServReducer = createSlice({
  name: "paintServ",
  initialState: {
    dataSource: [],
    totalPages: "",
  ...
  reducers: {
    ...
    getPaintServs: (state, action) => {},
    handleDel: () => {},
    getAll: () => {},
  },
});

export const paintServActions = { ...paintServReducer.actions };
export default paintServReducer.reducer;
