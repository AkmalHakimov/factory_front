...
const paintedFabReducer = createSlice({
  name: "paintedFab",
  initialState: {
    dataSource: [],
    totalPages: "",
  ...
  reducers: {
    ...
    getPaintedFabs: (state, action) => {},
    handleDel: () => {},
    getAll: () => {},
  },
});

export const paintedFabActions = { ...paintedFabReducer.actions };
export default paintedFabReducer.reducer;
