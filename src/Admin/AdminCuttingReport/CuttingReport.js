...
import TableWorkerReport from "./TableReport/TableCuttingReport";
import TableCuttingReport from "./TableReport/TableCuttingReport";
          ...
          {/* <Row className="my-3" gutter={16}>
            ...
            <Col span={12}>
              <Card bordered={false}>
                <Statistic
                  title="Chiqim"
                  value={toolStates.totalStatistic?.totalExpensePrice}
                  precision={2}
